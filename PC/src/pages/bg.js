...
function BG(){
	const myStyle={
        backgroundImage: "url('assests/images/login.jpg')",
        height:'91vh',
	...
	<div class="login-header box-shadow">
		<div class="container-fluid d-flex justify-content-between align-items-center">
			<div class="brand-logo">
				<a href="login.html">
					<img src="assests/images/techapp-logo.svg" alt=""/>
				</a>
			</div>
			<div class="login-menu">
				<ul>
					<li><a class="text-danger" href="register.js">Register</a></li>
				</ul>
			</div>
		</div>
	</div>
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="input-group mb-0">
										...
										--> */}
										<a class="btn btn-danger btn-lg btn-block" href="index.html">Login</a>
									</div>
